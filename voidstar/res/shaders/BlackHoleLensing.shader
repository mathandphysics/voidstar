...
vec3 rayMarch(vec4 sphere, vec2 disk, vec3 cameraPos, vec3 rayDir)
{
    ...
    for (int i = 0; i < maxSteps; i++)
    {
        ...
        // Technically, this takes account not only the curvature of time (as in plain Newtonian gravity), but also
        ...
        // photon rings will no longer be visible, e.g.  Technically speaking, the 2.0 is the result of the weak-field
